    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        Service Charge&emsp;&nbsp;:&emsp;&emsp;<span class="o-service_charge fw-bold"></span></li>
                                    <li class="list-group-item">
                                        Total Payable&emsp;&emsp;:&emsp;&emsp;<span class="o-total_payable fw-bold"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-action="print">Print</button>
