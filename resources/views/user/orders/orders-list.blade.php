...
@push('link-styles')
    ...
    <link href="{{ asset('assets/vendor/plugins/tom-select/tom-select.min.css?v=') . config('version.user_assets') }}" rel="stylesheet">
@endpush
@push('inline-styles')
...
@push('link-scripts')
    ...
    <script src="{{ asset('assets/vendor/plugins/tom-select/tom-select.complete.js?v=') . config('version.user_assets') }}"></script>
    <script src="{{ asset('assets/user/js/orders/orders-list.js?v=') . config('version.user_assets') }}"></script>
@endpush
@push('inline-scripts')
