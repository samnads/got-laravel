    ...
    <form id="quick-add-product" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header bg-light">
                <span class="text-dark"><span class="fs-6">Product have variations ?</span></span>&nbsp;&nbsp;&nbsp;
                <span class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pickup_vehicle_is_in_auction" id="visinaurgh"
                        value="10" checked>
                ...
                <span class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pickup_vehicle_is_in_auction" id="visinaurgy"
                        value="9">
            ...
            <div class="card-body" id="auction-details" style="display: non">
                <div class="row g-3">
                    <div class="col-md-2">
                        <label for="fgfgfg" class="form-label">Code
                            <rf />
                        </label>
                        <div class="position-relative">
                            <input type="text" step="1" class="form-control no-arrow" name="variant_codes[]"
                                id="fgfgfg" autocomplete="off" placeholder="GO001234">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <label for="gferer" class="form-label">Size
                            <rf />
                        </label>
                        <div class="position-relative">
                            <input type="number" step="1" class="form-control no-arrow" name="variant_sizes[]"
                                id="gferer" autocomplete="off" placeholder="2">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <label for="ggdfd" class="form-label">Label
                            <rf />
                        </label>
                        <div class="position-relative">
                            <input type="text" step="1" class="form-control no-arrow" name="variant_labels[]"
                                id="ggdfd" autocomplete="off" placeholder="1 kg">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <label for="dfdfw" class="form-label">MRP.
                            <rf />
                        </label>
                        <div class="position-relative">
                            <input class="form-control" id="dfdfw" name="variant_mrps[]" placeholder="123.5">
                        </div>
                    </div>
                </div>
            </div>
