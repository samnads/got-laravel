                    ...
                    <div class="col-md-7">
                                    ...
                                    <select class="form-control" id="gdassd" name="brand_id" autocomplete="off">
                                        ...
                                        @foreach ($brands as $key => $brand)
                                            <option value="{{ $brand->value }}"
                                                {{ $brand->value == $product->brand_id ? 'selected' : '' }}>
                                                {{ $brand->label }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select type="text" class="form-control" id="hsfbzs" name="unit_id"
                                        ...
                                        @foreach ($units as $key => $unit)
                                            <option value="{{ $unit->value }}"
                                                {{ $unit->value == $product->unit_id ? 'selected' : '' }}>
                                                {{ $unit->label }}
                                                ({{ $unit->code }})
                                            </option>
                                        @endforeach
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4">
                                ...
                                <div class="position-relative">
                                    <textarea class="form-control" id="desdssw" name="description">{{ $product->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="position-relative">
                            <input type="number" step="1" class="form-control no-arrow" id="uids"
                                name="item_size" autocomplete="off" value="{{ round($product->item_size) }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="p-2 flex-grow-1"><span class="text-dark"><span class="fs-6">Product have variations
                        ...
                        <span class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="have_variations" id="visinaurgh"
                                value="0" {{ $product->parent_product_id == null ? 'checked' : '' }}>
                        ...
                        <span class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="have_variations" id="visinaurgy"
                                value="1" {{ $product->parent_product_id != null ? 'checked' : '' }}>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control no-arrow variant_codes"
                                        name="variant_codes[{{ $key }}]" autocomplete="off"
                                        placeholder="GO001234" value="{{ $variant->code }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="position-relative">
                                    <input type="number" step="1" class="form-control no-arrow variant_sizes"
                                        name="variant_sizes[{{ $key }}]" autocomplete="off" placeholder="2"
                                        value="{{ round($variant->item_size) }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control no-arrow variant_labels"
                                        name="variant_labels[{{ $key }}]" autocomplete="off" placeholder="1 kg"
                                        value="{{ $variant->variant_option_name }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="position-relative">
                                    <input type="number" class="form-control no-arrow variant_mrps"
                                        name="variant_mrps[{{ $key }}]" placeholder="123.5"
                                        value="{{ $variant->maximum_retail_price }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="position-relative">
                                    <input class="form-control variant_thumbnail_images" type="file"
                                        name="variant_thumbnail_images[{{ $key }}]" accept="image/*">
                                </div>
                            </div>
                            <div class="col-md-1 text-right">
                                <label class="form-label">&nbsp;</label>
                                <div class="d-flex justify-content-end"><button data-action="remove-variant"
                                        type="button" class="btn btn-primary btn-sm btn-danger"><i
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex bd-highlight">
                    ...
                    <div class="p-2 bd-highlight"><button type="submit" class="btn btn-success">Update</button></div>
                </div>
            </div>
        </div>
    </form>
...
@push('link-scripts')
    ...
    <script src="{{ asset('assets/user/js/products.edit.js?v=') . config('version.user_assets') }}"></script>
@endpush
@push('inline-scripts')
