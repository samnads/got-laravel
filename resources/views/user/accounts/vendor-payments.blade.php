...
@section('content')
    ...
    <div class="d-flex justify-content-end mb-3">
        ...
        <button data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="New Payment" type="button"
            class="btn btn-sm btn-light border" data-action="new-payment"><i class="bx bx-plus"></i>
        </button>
    ...
    @include('user.accounts.popup-new-payment')
@endsection
@push('link-styles')
    <!-- Pushed Link Styles -->
...
@push('link-scripts')
    ...
    <script src="{{ asset('assets/user/js/accounts/vendor-payments-list.js?v=') . config('version.user_assets') }}"></script>
