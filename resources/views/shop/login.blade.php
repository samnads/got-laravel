...
<head>
    ...
    <!--plugins-->
    <link href="{{ asset('assets/vendor/plugins/simplebar/css/simplebar.css')}}" rel="stylesheet" />
    ...
    <link href="{{ asset('assets/vendor/css/bootstrap-extended.css')}}" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap" rel="stylesheet">
    <link href="{{ asset('assets/vendor/css/app.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/css/icons.css')}}" rel="stylesheet">
    <!-- Toast -->
...
<body class="">
                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    <div class="mb-3 text-center">
                                        <img src="{{ asset('assets/vendor/images/logo-icon.png')}}" width="180" alt="" />
                                    </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0"
                                                        id="password" placeholder="Enter Password" name="password"> <a href="javascript:;"
    ...
    <script src="{{ asset('assets/vendor/js/jquery.toast.min.js')}}"></script>
